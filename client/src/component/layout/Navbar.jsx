    ...
    <>
      ...
      <div className="w-full h-[4rem] border shadow-md sm:flex justify-center items-center hidden">
        <div className="container flex justify-between items-center relative">
          ...
          {/* login model */}
          <div className="absolute top-[20rem] left-1/2 transform -translate-x-1/2 -translate-y-1/2  bg-white rounded-lg box-shadow w-[25rem] h-[30rem] z-[500] flex flex-col gap-4 p-6">
            <div className="flex justify-end">
              <div className=" p-2 shadow-md w-[2.1rem] h-[2.1rem] rounded-[100%] flex justify-center items-center border border-dashed cursor-pointer">
            ...
            <div className="w-full h-10 rounded-md bg-[#E11B70] cursor-pointer text-center flex justify-center items-center">
              <span className="text-sm font-bold text-white">Log in</span>
            </div>
            <div className="w-full h-10 rounded-md border border-black text-[#39434d] cursor-pointer text-center flex justify-center items-center hover:bg-[#fdf2f7] hover:border-[#fdf2f7] hover:text-[#171F26]">
